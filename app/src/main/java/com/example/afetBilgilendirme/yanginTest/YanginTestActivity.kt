...
class YanginTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.yangin_test)
    ...
    val soruDB = YanginSoruDatabase(this)
    ...
    private fun kontrolEt() {
        ...
        val yanitwer = radioGroup!!.indexOfChild(radioSelected) + 1

        if (yanitwer == mevcutSoru!!.getmYanit()) {
            puan++
